...
{MENU}</ul></div>
			...
			<div class="logo">
				<a href=""><img src="/templates/default/img/logo 01.png" onMouseOver="this.src='/templates/default/img/logo.gif'" onMouseOut="this.src='/templates/default/img/logo 01.png'" ></a>
			</div>
			<div class="sales_img">
				<p>Скидка<br>1,05%</p>
			...
			<div class="contancts-ei">
				<p>+7 800 34 34 55</p>
				<a href="">Позвонить с сайта</a><br>
				<span class="click-back-call">Заказать звонок</span>
			</div>
			<div class="section pge-col4" id="section0">
				<div class="intro">
					<div class="intro_title"><h1>{H1}</h1></div>
				</div>
					<div class="pre-t">
						<div>
{MAIN}
			...
			<div class="section pge-col2" id="section1">
				<div class="intro">
			...
			<div class="section pge-col3" id="section2">
				<div class="intro">
					<div class="intro_title">Ваше пространство для бизнеса</div>
				</div>
...
{FAQ}</div>
		...
		<div class="menu-slider">
			<ul>
				<li class="item-01 item-01-show"><a href="#">Исходящие звонки</a></li>
				<li class="item-02 item-02-show"><a href="#">Входящие звонки</a></li>
				<li class="item-03 item-03-show"><a href="#">Базы компаний</a></li>
			</ul>
		</div>
	</div>
								...
								<li class="opene_li">
									...
									<ul>
										<li class="point_check submenu2">
											<span>
												<input type="checkbox" id="f3" name="cc" class="check-all-submenu check-all-categories" />
											...
											<ul class="submenu-check ul-submenu-bordernone" >
												<li>
												<span>
													<input type="checkbox" id="f4" name="cc" class="check-all-categories" />
													<label for="f4"><span></span></label>
												</span>
												<a href="#">Аварийные службы</a></li>
												<li>
												<span>
													<input type="checkbox" id="f5" name="cc" class="check-all-categories" />
													<label for="f5"><span></span></label>
												</span>
												<a href="#">Аварийные службы</a></li>
												<li>
												<span>
													<input type="checkbox" id="f6" name="cc" class="check-all-categories" />
							...
							<ul class="search-map">
								...
								<li class="opene_li">
									...
									<ul>
										<li class="point_check submenu2">
											<span>
												<input type="checkbox" id="s3" name="cc" class="check-all-submenu check-all-categories" />
											...
											<ul class="submenu-check ul-submenu-bordernone" >
												<li>
												<span>
													<input type="checkbox" id="s4" name="cc" class="check-all-categories" />
													<label for="s4"><span></span></label>
												</span>
												<a href="#">Аварийные службы</a></li>
												<li>
												<span>
													<input type="checkbox" id="s5" name="cc" class="check-all-categories" />
													<label for="s5"><span></span></label>
												</span>
												<a href="#">Аварийные службы</a></li>
												<li>
												<span>
													<input type="checkbox" id="s6" name="cc" class="check-all-categories" />
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter33214753 = new Ya.Metrika({
                    id:33214753,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/33214753" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<script src="/templates/default/js/jquery.mousewheel.js"></script>
<script src="/templates/default/js/jquery.jscrollpane.min.js"></script>
